    ...
    render() {
     console.log("data in state",this.props.details);
        const InputData = [
            ...
            { Field: "Password", type: "password", placeholder: "Enter password", passwordError:"enter strong password"},
            { Field: "Confirm Password", type: "text", placeholder: "Re-enter password", cPasswordError:"check password and re-enter"}
        ]
                        ...
                        <View>
                            ...
                            {InputData.map((input, index) =>
                                <View style={styles.padding1} key={index}>
                                    ...
                                    <TextInput keyboardType={input.type} placeholder={input.placeholder} style={styles.input} maxLength={input.Field === 'Number' ? 10 : null} secureTextEntry={(input.type === 'password' || input.Field==='Confirm Password') ? true : false} onChangeText={(value) => { this.Validate(input.type, value) }}></TextInput>
